...
export default function ProfileContact({ member }: ProfileContactProps) {
  return (
    <section className="py-12 bg-white dark:bg-gray-800 transition-colors duration-200">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-8 text-gray-900 dark:text-white">Connect</h2>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-10">
          {member.socialLinks.map((link, index) => (
            <Link 
              ...
              className="flex items-center gap-3 text-gray-700 dark:text-gray-300 hover:text-primary dark:hover:text-blue-400 transition-colors"
            >
